...
?>
<h2><?php  __('Story');?>&nbsp;#<?php echo $story['Story']['id']; ?>&nbsp;<?php echo h($story['Story']['name']); ?> (<?php echo $resolution_name; ?>)</h2>
...
<div class="related">
	...
	<?php
		...
		<tr<?php echo $class;?>>
			...
			<td><?php echo $this->Html->link(h($task['Sprint']['name']), array('controller' => 'sprints', 'action' => 'view', $task['sprint_id']));?></td>
			...
			<td class="actions narrow">
				...
				<?php echo $this->Html->link($html->image('edit.png'), array('controller' => 'tasks', 'action' => 'edit', $task['id'], '?' => 'return_url=' . urlencode($_SERVER["REQUEST_URI"])), array('escape' => false)); ?>
